...
style: """
  ...
  .location
    ...
    bottom: 0.8125em;
    text-align: right;
    padding: 0 1.25em 1.25em 2.8125em;
    text-shadow: 0 0 1px rgba(0,0,0,0.8), 1px 1px 2px rgba(0,0,0,0.6);
...
update: (output, domEl) ->
  $.getJSON 'earth-view.widget/data.json', (data) ->
